...
shot_fx = pygame.mixer.Sound(resource_path('audio/shot.wav'))
...
start_img = pygame.image.load(resource_path(
    'img/start_btn.png')).convert_alpha()
exit_img = pygame.image.load('img/exit_btn.png').convert_alpha()
restart_img = pygame.image.load('img/restart_btn.png').convert_alpha()
# background
pine1_img = pygame.image.load(resource_path(
    'img/Background/pine1.png')).convert_alpha()
pine2_img = pygame.image.load('img/Background/pine2.png').convert_alpha()
mountain_img = pygame.image.load('img/Background/mountain.png').convert_alpha()
sky_img = pygame.image.load('img/Background/sky_cloud.png').convert_alpha()
win_img = pygame.image.load('img/Background/win.png').convert_alpha()
win_img = pygame.transform.scale(
    win_img, (SCREEN_WIDTH, SCREEN_HEIGHT))
...
class Soldier(pygame.sprite.Sprite):
    def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
        ...
        for animation in animation_types:
            ...
            num_of_frames = len(os.listdir(resource_path(
        ...
        if self.alive and player.alive:
            ...
            if self.vision.colliderect(player.rect):
                ...
                if self.idling == False:
                    ...
                    self.vision.center = (self.rect.centerx + 75 *
...
class ScreenFade():
    ...
    def fade(self):
        ...
        if self.direction == 1:  # whole screen fade
            pygame.draw.rect(screen, self.colour, (0 - self.fade_counter,
...
# Add this global variable to track if the game is won
game_won = False
...
while run:
    ...
    if start_game == False:
        ...
        if game_won:
            # Display "You Win" message when the player completes the last level
            screen.fill(BG)
            screen.blit(win_img, (0, 0))
            pygame.display.flip()
            # Pause the game for 5 seconds (5000 milliseconds) before closing or restarting
            pygame.time.delay(5000)
            run = False  # Exit the game loop after displaying the win screen
        else:
